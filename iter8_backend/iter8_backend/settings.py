"""
Django settings for iter8_backend project.
...
SECRET_KEY = 'django-insecure-p#40w*i@*4%pl3)lkaz$j$0!u)&hz=#nieqlk-hp85=(k6*9+%'
...
ROOT_URLCONF = 'iter8_backend.urls'
...
WSGI_APPLICATION = 'iter8_backend.wsgi.application'
